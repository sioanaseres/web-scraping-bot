...
urls = ['https://finance.yahoo.com/quote/GOOGL?p=GOOGL&.tsrc=fin-srch', 'https://finance.yahoo.com/quote/AMZN?.tsrc=fin-srch', 'https://finance.yahoo.com/quote/MSFT?.tsrc=fin-srch' ]
...
for url in urls:
    ...
    current_price= header_info.find("div", class_="My(6px) Pos(r) smartphone_Mt(6px) W(100%)").find_all("fin-streamer")[0].get_text()
